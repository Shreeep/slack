...
def test_message_send(): 
    ...
    another_test_channel = channels.channels_create(user1['token'], 'Channel #2', True)
...
def test_message_remove_owner_permission():
    ...
    another_test_channel = channels.channels_create(user1_owner['token'], 'Channel #2', True)
